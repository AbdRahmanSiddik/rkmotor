...
@section('content')
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          <form action="{{ route('barang.store') }}" method="POST" novalidate enctype="multipart/form-data"
              ...
              <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="mb-3">
                        ...
                        <input type="number" inputmode="numeric" class="form-control @error('stok') is-invalid @enderror"
                          name="stok" id="stok" aria-describedby="helpId" placeholder="Masukkan Stok" required />
                        <small class="invalid-feedback">
                          @error('stok')
                            {{ $messade }}
                          @enderror
                ...
                <div class="col-md-4">
                  <div class="mb-3">
                    ...
                    <!-- Tempat Preview -->
                    <div class="image-preview @error('gambar') is-invalid @enderror" id="imagePreview" onclick="document.getElementById('fileInput').click();">
                      Masukkan Gambar
                    </div>
                    <!-- Input File (Hidden) -->
                ...
                <div class="col-md-12">
                    <div class="mb-3">
                        ...
                        <textarea
                          ...
                          aria-describedby="helpId" placeholder="Masukkan deskripsi"rows="10" required ></textarea>
                        <small class="invalid-feedback">
                          @error('deskripsi')
                            {{ $messade }}
                          @enderror
