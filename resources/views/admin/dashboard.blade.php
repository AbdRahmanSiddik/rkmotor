          ...
          <div class="card-body">
            ...
            <div>
              ...
              <div class="progress mb-1">
                ...
                <div class="progress-bar bg-info" role="progressbar" style="width: 28%" aria-valuenow="28"
                  aria-valuemin="0" aria-valuemax="100">28%</div>
                <div class="progress-bar bg-soft-secondary" role="progressbar" style="width: 17%" aria-valuenow="17"
                  aria-valuemin="0" aria-valuemax="100">17%</div>
              </div>
            </div>
          </div><!--end card-body-->
        </div><!--end card-->
          ...
          <div class="card-body">
            <div class="table-responsive browser_users">
              <table class="table mb-0">
                ...
                <tbody>
                  <tr>
                    <td><img src="{{ asset('') }}assets/images/logos/chrome.png" alt="" height="16"
                  ...
                  <tr>
                    <td><img src="{{ asset('') }}assets/images/logos/micro-edge.png" alt="" height="16"
                  ...
                  <tr>
                    <td><img src="{{ asset('') }}assets/images/logos/in-explorer.png" alt="" height="16"
                  ...
                  <tr>
                    <td><img src="{{ asset('') }}assets/images/logos/opera.png" alt="" height="16"
                        class="me-2">Opera</td>
                    <td>1958<small class="text-muted">(31%)</small></td>
                    <td> 36.82%</td>
                    <td>361<small class="text-muted">(61%)</small></td>
